...
class Config(object):
    ...
    LOG_CHANNEL = get_config("LOG_CHANNEL", "-1002437314123")
    UPDATES_CHANNEL = get_config("UPDATES_CHANNEL", "mltbrm") # Without `@` LOL
     # Get these values from my.telegram.org
    AUTH_USERS = get_config("AUTH_USERS", "7945551029")
